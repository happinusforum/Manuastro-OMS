        ...
        <div className="p-6 h-full flex flex-col">
            <div className="flex flex-wrap justify-between items-center mb-6 gap-4 border-b pb-4">
                <div className="flex items-center gap-4">
                    ...
                    <div><h2 className="text-2xl font-bold text-gray-800">📄 {folder.name}</h2><span className="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded">Data Sheet</span></div>
                </div>
                    ...
                    <table className="w-full text-left border-collapse min-w-[800px]">
                        <thead className="bg-gray-100 border-b">
                            <tr>
                                ...
                                <th className="p-4 bg-gray-50 w-24 text-center font-bold text-gray-700 sticky right-0 shadow-[-5px_0_5px_-5px_rgba(0,0,0,0.1)]">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            {folderData.length > 0 ? (
                                ...
                                <tr><td colSpan={folder.fields.length + 1} className="p-10 text-center text-gray-400 italic">No data. Click "+ Add Row" to start.</td></tr>
                            )}
                        </tbody>
                    </table>
                )}
