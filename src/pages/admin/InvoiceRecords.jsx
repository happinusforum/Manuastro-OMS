...
const InvoiceRecords = () => {
  ...
  const printInvoice = (data) => {
    ...
    doc.text("MANUASTRO LLP", 15, 20);
    doc.setFontSize(9);
    doc.setFont("helvetica", "normal");
    doc.text("Manuastro LLP, Shop-6, Chandracharya Appt, Kankhal-Haridwar, UK-249408", 15, 26);
    doc.text("GSTIN: 05ABUFM4993RIZZ | E: contact@manuastro.com", 15, 31);
    ...
    doc.text("For MANUASTRO LLP.", 195, bankY + 6, { align: "right" });
