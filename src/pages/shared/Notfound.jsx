            ...
            <div className="relative z-10 text-center max-w-lg">
                ...
                <div className="-mt-10">
                    ...
                    <Link to="/login" className="inline-block group">
                        <button className="relative px-8 py-3 bg-blue-600 text-white font-bold rounded-full shadow-lg transition-transform transform group-hover:-translate-y-1 group-active:translate-y-0 overflow-hidden">
