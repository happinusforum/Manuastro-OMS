...
export const generatePayslipBlob = (data) => {
    ...
    addText(`Email: ${COMPANY_DETAILS.email} | Web: ${COMPANY_DETAILS.website}`, centerX, currentY + 19, 9, "normal", "center");
    ...
    addText("For MANUASTRO LLP", width - 50, sigY - 10, 8, "normal");
